...
import ru.zimin.util.exception.ErrorInfo;
...
public class ExceptionInfoHandler {
    ...
    @ExceptionHandler(VotingTimeViolationException.class)
    @ResponseBody
    public ErrorInfo votingTimeViolation(HttpServletRequest req, VotingTimeViolationException e) {
        return new ErrorInfo(req.getRequestURL(), e.getLocalizedMessage());
    }
